                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                          ...
                          <span>Passwort:</span>
                          <br>
                          <span><%=(String) request.getServletContext().getAttribute("password")%></span>
						  <br> </h2>
						  
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Vorname:</span>
                          <br>
                          <span><%=(String) user.getString("firstname")%></span>
						  <br> </h2>
                          						  
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Nachname:</span>
                          <br>
                          <span><%=(String) user.getString("lastname")%></span>
						  <br> </h2>

						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Wohnort:</span>
                          <br>
                          <span><%=(String) user.getString("city")%></span>
						  <br> </h2>
					 ...
					 <form action="ChangePasswordServlet" Method="POST" >
						  ...
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
						  <span>	  <input type="submit" value="Aenderung bestaetigen"> </span> 
						  </h2>
